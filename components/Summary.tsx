...
const Summary = () => {
    return (
        <section className='w-full py-8  text-center text-[#131313]'>
            ...
            <p className="mb-6 text-[1rem] font-normal leading-[1.375rem] tracking-[.0.03rem] opacity-80 ">Subscribe to our newsletter and be a part of the vibrant Rare Eat Fresh community. Stay connected with the latest updates, exclusive offers, and exciting promotions on rare West African food ingredients.</p>
